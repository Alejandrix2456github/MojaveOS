...
# --- Global Settings ---
osname = "MojaveOS 1.0"
username = None # again will be set during login
default_dir = "home"
...
def extract_app(app_package_path):
    ...
    if not app_package_path.endswith(".zip"):
        print("Error: Invalid app package format. Must end with '.zip'")
        return
...
def change_settings():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("2. .zip (run apps from .zip packages)")
            ...
            if mode_choice == "1":
                ...
                settings["run_mode"] = "zip"
                print("App run mode set to '.zip'.")
            else:
                print("Invalid choice.")
        elif choice == "2":
